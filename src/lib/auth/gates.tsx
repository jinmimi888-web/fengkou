...
import { SOCIAL_PROVIDERS, authEnabled, signIn, signOut } from "./client";
    ...
    <div className="flex items-center gap-2">
      ...
      {authEnabled && !gateSession && (
        <button
          ...
          className="h-8 cursor-pointer rounded-md px-2 text-sm text-muted-foreground hover:bg-secondary hover:text-foreground disabled:cursor-wait"
        >
          {signingOut ? "退出中" : "退出"}
        </button>
      )}
